...
import type { MatchEvent, PlayerTelemetry, ServerMetrics, TelemetryTimeRange, PlayerStatsAggregation } from '../entities/telemetry.entity'
...
export interface TelemetryRepository {
  ...
  readonly getPlayerStatsAggregation: (playerId: string, timeRange: TelemetryTimeRange) => Effect.Effect<PlayerStatsAggregation, TelemetryError>
}
