...
import type { Player, PlayerStats, PlayerProgression, CreatePlayerInput, UpdatePlayerInput } from '../entities/player.entity'
...
export interface PlayerRepository {
  ...
  readonly update: (playerId: string, input: UpdatePlayerInput) => Effect.Effect<Player, PlayerNotFoundError>
